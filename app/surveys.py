...
COMMUNICATION_QUESTION_KK = (
    "Командада ең белсенді қарым-қатынас жасаған, шешімдері мен идеялары "
    "тапсырмаларды оңай әрі сапалы орындауға көмектескен кім?"
)
FEEDBACK_QUESTION_RU = "Оцените мероприятие и оставьте отзыв — нам будет приятно."
FEEDBACK_QUESTION_KK = "Іс-шараны бағалап, пікіріңізді қалдырыңыз — бізге өте жағымды болады."
