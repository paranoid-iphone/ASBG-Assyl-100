...
DETECTIVE_REASON_RU = (
    "Виктор нашёл потерянную карту Бориса, а его светлая куртка совпадает с записью камеры у архива. "
    "Айдар, Борис и Галина в момент открытия двери находились в других местах, что подтверждают камеры и чек."
)
...
def generate_cases_for_stage(db: Session, stage: Stage) -> list[DetectiveCase]:
    ...
    # Use the same canonical clue list that the admin preview renders.
    clue_cards = DETECTIVE_CLUES
    story_ru = (
